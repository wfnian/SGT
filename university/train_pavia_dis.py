...
class Args():
    def __init__(self) -> None:
        ...
        self.head = 3
        self.depth = 3
        self.dim = 256  #~512 0.2 最佳
        self.isDerive2 = False
        self.shift = 3
        self.shift2 = 1
        ...
        self.batch_size = 512
        self.dropout = 0.1  #~ 0.2目前最佳
        self.patience = 80
        self.is_ms = False
        self.raw_embed = False
        self.bestScore = 0.
        self.recode = [0., 0., 0.]
...
def main():
    ...
    # model = ResNet34().to(args.device).to(torch.float32)
    # flops, params = profile(model, inputs=(torch.rand(1, 3, 128, 128).to(torch.float32).cuda(), ))
    # print()
